...
class EventBus:
 def __init__(self,max_retries=2,base_delay=0.05):self.max_retries=max_retries;self.base_delay=base_delay;self.handlers={};self.processed=set();self.dead_letters=[]
