...
Version event contracts; separate ingestion, domain handling, and delivery; make consumers idempotent; define retry/dead-letter semantics explicitly; prevent unbounded queue or batch growth.
