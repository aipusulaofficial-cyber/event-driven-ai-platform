...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Versioned events, consumers and retry/dead-letter boundaries and system boundaries |
| ADR | [0002-production-hardening.md](../ADRs/0002-production-hardening.md) | Explicit design trade-offs and production boundaries |
| Contracts | [tests/test_events.py](../tests/test_events.py) | Contract-focused validation at the repository boundary |
